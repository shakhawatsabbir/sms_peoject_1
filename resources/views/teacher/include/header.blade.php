                ...
                <li class="nav-item dropdown dropdown-large">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" data-bs-toggle="dropdown">
                        <div class="user-setting d-flex align-items-center gap-1">
                            <img src="{{Session::get('user_image')}}" class="user-img" alt="">
                        ...
                        <li>
                            <a class="dropdown-item" href="#">
                                <div class="d-flex align-items-center">
                                    <img src="{{Session::get('user_image')}}" alt="" class="rounded-circle" width="60" height="60">
                                    <div class="ms-3">
...
{{--                                        <h6 class="mb-0 dropdown-user-name">{{Auth::user()->name}}</h6>--}}
                        ...
                        <li><hr class="dropdown-divider"></li>
                        <li>
                            <a class="dropdown-item" href="authentication-signup-with-header-footer.html" onclick="event.preventDefault(); document.getElementById('teacherLogoutForm').submit();">
                                <div class="d-flex align-items-center">
