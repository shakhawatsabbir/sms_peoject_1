                ...
                <div class="card shadow rounded-0 overflow-hidden">
                    <div class="row g-0">
                        <div class="col-lg-6 bg-login d-flex align-items-center justify-content-center">
                            <img src="{{asset('adminAssets')}}/assets/images/error/login-img.jpg" class="img-fluid" alt="">
                        </div>
                        <div class="col-lg-6">
                            ...
                            <img class="me-2" src="{{asset('adminAssets')}}/assets/images/icons/search.svg" width="16" alt="">
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12">
                                            ...
                                            <div class="ms-auto position-relative">
                                                ...
                                                <input type="email" name="email" class="form-control radius-30 ps-5" id="email" placeholder="Email Address">
                                            </div>
                                        </div>
                                        <div class="col-12">
